...
int main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    std::cout << "================================================================\n";
    std::cout << "ML-DSA (Module-Lattice Digital Signature Algorithm) Example\n";
    std::cout << "================================================================\n\n";
    
    std::cout << "This example demonstrates ML-DSA (formerly CRYSTALS-Dilithium),\n";
    std::cout << "a post-quantum digital signature algorithm standardized in NIST\n";
    std::cout << "FIPS 204. ML-DSA provides secure digital signatures that are\n";
    std::cout << "resistant to attacks from both classical and quantum computers.\n";
    std::cout << "This example demonstrates batch processing of key generation,\n";
    std::cout << "signing, and verification operations using GPU acceleration.\n\n";
    
    constexpr unsigned int batch = 10;
    constexpr size_t message_size = 1024;
    
    std::cout << "Configuration: ML-DSA-44, batch size: " << batch << " key pairs\n";
    ...
    std::cout << "Signing\n";
    std::cout << "========================================\n";
    std::cout << "Signing " << batch << " messages...\n";
    /*
     * Create signature from message and secret key!
     */
    std::vector<uint8_t> signatures((MLDSA44Sign::signature_size + 7) / 8 * 8 * batch);
    std::vector<uint8_t> messages(message_size * batch);
    ml_dsa_sign(signatures, messages, message_size, secret_keys, batch);
    std::cout << "Signing completed.\n\n";

    std::cout << "========================================\n";
    std::cout << "Verification\n";
    std::cout << "========================================\n";
    std::cout << "Verifying " << batch << " signatures...\n";
    ...
    for (size_t i = 0; i < batch; i++) {
        if (is_valids[i]) valid_count++;
    }
    
    std::cout << "Verification completed.\n";
    std::cout << "  Valid signatures: " << valid_count << " / " << batch << "\n\n";
    
    std::cout << "ML-DSA operations completed successfully.\n";
}
